...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f7f2eb] text-[#1a1a1a] antialiased">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 py-3.5">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-xs text-[#5a5a5a] hidden sm:block">
                Ministry of Statistics & Programme Implementation • Government of India
              </p>
            </div>
          </div>

          <nav className="hidden lg:flex items-center gap-6 text-sm font-medium text-[#5a5a5a]">
          ...
          <div className="flex items-center gap-3">
            {activeUser ? (
              <Link
                href="/dashboard"
                className="inline-flex items-center gap-2 rounded-md bg-[#8b9a6e] px-4 py-2 text-xs sm:text-sm font-semibold text-white shadow-xs hover:bg-[#728056] transition-colors"
              >
      ...
      <main className="flex-1">
        <section className="relative px-4 sm:px-6 pt-16 pb-20 max-w-5xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg text-[#5a5a5a] max-w-3xl mx-auto leading-relaxed mb-10">
            {t('hero.subtitle')}
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 max-w-md mx-auto">
            {activeUser ? (
              <>
                <Link
                  href="/dashboard"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-md bg-[#8b9a6e] text-white font-semibold text-sm shadow-xs hover:bg-[#728056] transition-colors"
                >
              ...
              <>
                <Link
                  href="/auth/login"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-md bg-[#8b9a6e] text-white font-semibold text-sm shadow-xs hover:bg-[#728056] transition-colors"
                >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16 pt-10 border-t border-[#e3dbcf] text-left">
            <div className="p-4 rounded-xl bg-white border border-[#e3dbcf]">
              ...
              <div className="text-xs text-[#5a5a5a] mt-1">{t('stats.cadresDesc')}</div>
            </div>
            <div className="p-4 rounded-xl bg-white border border-[#e3dbcf]">
              <div className="text-xl sm:text-2xl font-bold text-[#1a1a1a]">{t('stats.competencies')}</div>
              <div className="text-xs text-[#5a5a5a] mt-1">{t('stats.competenciesDesc')}</div>
            </div>
            <div className="p-4 rounded-xl bg-white border border-[#e3dbcf]">
              <div className="text-xl sm:text-2xl font-bold text-[#1a1a1a]">{t('stats.coverage')}</div>
              <div className="text-xs text-[#5a5a5a] mt-1">{t('stats.coverageDesc')}</div>
            </div>
            <div className="p-4 rounded-xl bg-white border border-[#e3dbcf]">
              <div className="text-xl sm:text-2xl font-bold text-[#1a1a1a]">{t('stats.offline')}</div>
              <div className="text-xs text-[#5a5a5a] mt-1">{t('stats.offlineDesc')}</div>
            </div>
          </div>
        </section>
        ...
        <section id="capabilities" className="px-4 sm:px-6 py-16 bg-white border-y border-[#e3dbcf]">
          <div className="max-w-6xl mx-auto space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Pillar 1 */}
              <div className="rounded-xl border border-[#e3dbcf] bg-[#f7f2eb]/60 p-6 space-y-3">
              ...
              {/* Pillar 5 */}
              <div className="rounded-xl border border-[#e3dbcf] bg-[#f7f2eb]/60 p-6 space-y-3 md:col-span-2">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#8b9a6e] text-white">
        ...
        <section id="framework" className="px-4 sm:px-6 py-16 max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-xl bg-white border border-[#e3dbcf] p-6 space-y-2.5">
              <span className="inline-block px-2.5 py-1 rounded text-xs font-semibold bg-[#8b9a6e]/15 text-[#728056]">
                Category I
              </span>
          ...
          <div className="rounded-xl bg-white border border-[#e3dbcf] p-6 sm:p-8 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 pt-2">
              <div className="p-3.5 rounded-lg border border-[#e3dbcf] bg-[#f7f2eb]/50">
        ...
        <section id="cadres" className="px-4 sm:px-6 py-16 bg-white border-t border-[#e3dbcf]">
          <div className="max-w-6xl mx-auto space-y-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="p-5 rounded-xl border border-[#e3dbcf] bg-[#f7f2eb]/50 space-y-2">
                <h3 className="text-sm font-bold text-[#1a1a1a]">{t('cadres.iss.title')}</h3>
                <p className="text-xs text-[#5a5a5a] leading-relaxed">{t('cadres.iss.desc')}</p>
              </div>
              <div className="p-5 rounded-xl border border-[#e3dbcf] bg-[#f7f2eb]/50 space-y-2">
                <h3 className="text-sm font-bold text-[#1a1a1a]">{t('cadres.sss.title')}</h3>
                <p className="text-xs text-[#5a5a5a] leading-relaxed">{t('cadres.sss.desc')}</p>
              </div>
              <div className="p-5 rounded-xl border border-[#e3dbcf] bg-[#f7f2eb]/50 space-y-2">
                <h3 className="text-sm font-bold text-[#1a1a1a]">{t('cadres.nsso.title')}</h3>
                <p className="text-xs text-[#5a5a5a] leading-relaxed">{t('cadres.nsso.desc')}</p>
              </div>
              <div className="p-5 rounded-xl border border-[#e3dbcf] bg-[#f7f2eb]/50 space-y-2">
                <h3 className="text-sm font-bold text-[#1a1a1a]">{t('cadres.nssta.title')}</h3>
                <p className="text-xs text-[#5a5a5a] leading-relaxed">{t('cadres.nssta.desc')}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="about" className="px-4 sm:px-6 py-16 max-w-5xl mx-auto space-y-8">
          <div className="rounded-2xl border border-[#e3dbcf] bg-white p-6 sm:p-10 space-y-6">
            ...
            <div className="pt-6 border-t border-[#e3dbcf] grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-[#5a5a5a]">
              <div>
      ...
      <footer className="border-t border-[#e3dbcf] bg-white py-8 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#5a5a5a]">
          <div className="flex items-center gap-2">
